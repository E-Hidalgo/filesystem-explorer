<?php
include_once "includes/addfile.php";
...
<body>
  ...
  <main id="page-content">
    <table class="table">
      ...
      <?php if(!empty($filesAdded)):?>
      <tbody>
        <?php foreach($filesAdded as $file):?>
        <tr>
          <td>
            <a href="includes/openfile.inc.php?path=<?=$file["path"];?>"><?php echo $file["name"]?></a>
          </td>
